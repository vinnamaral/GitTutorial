...
Logo depois vai aparecer uma página um pouco cinza e confusa e com vários comandos, mas o que você tem que fazer é bem simples, apenas copie o link que aparecer para você

Agora iremos utilizar o conceito de `remote`
...
* O comando para puxar o projeto para a sua máquina é o `git clone <URL para o git>`
...
Você só precisa apertar nesse botão dentro do repositório e BOOM! Ele aparece automaticamente lá na sua conta.
